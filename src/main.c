...
int main(int argc, char **argv) {
    ...
    controller_t down_controller = {-1, SDL_HAT_DOWN, 1, -1};
    ...
    control_t down_control = {SDL_SCANCODE_S, &down_controller, NULL};
    ...
    Component *thing = ControlSide(250, &up_control, &down_control, &left_control, &right_control);
